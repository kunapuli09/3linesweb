...
func (app *Application) mux() *gorilla_mux.Router {
	...
	router.HandleFunc("/apply", handlers.NewApplication).Methods("GET")
	...
	router.HandleFunc("/adminrevenuedashboard", handlers.GetRevenueSummaryDashboard).Methods("GET")
	...
	router.HandleFunc("/newfinancials", handlers.NewFinancialResults).Methods("GET")
	router.HandleFunc("/editfinancials", handlers.EditFinancialResults).Methods("GET")
	router.HandleFunc("/updatefinancials", handlers.UpdateFinancialResults).Methods("POST")
	router.HandleFunc("/removefinancials", handlers.RemoveFinancialResults).Methods("GET")
	...
	router.HandleFunc("/investmentDocs", handlers.GetInvestmentDocs).Methods("GET")
